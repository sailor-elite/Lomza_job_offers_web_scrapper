...
url_physical = "https://zambrow.org/ogloszenia/praca/praca-fizyczna/dam-prace/strona1"

url_driver = "https://zambrow.org/ogloszenia/praca/praca-kierowca/dam-prace/strona1"

url_office = "https://zambrow.org/ogloszenia/praca/praca-biurowa--administracja/dam-prace/strona1"

url_additional = "https://zambrow.org/ogloszenia/praca/praca-dodatkowa/dam-prace/strona1"

url_cook = "https://zambrow.org/ogloszenia/praca/praca-w-gastronomi/dam-prace/strona1"

url_shop = "https://zambrow.org/ogloszenia/praca/praca-w-sklepie/strona1"

url_other = "https://zambrow.org/ogloszenia/praca/praca-pozostale/dam-prace/strona1"

url_IT = "https://zambrow.org/ogloszenia/praca/praca-it-informatyk/strona1"
...
def mainzambrow():
    ...
    with pd.ExcelWriter("data_base.xlsx", engine="openpyxl", mode='a', if_sheet_exists='replace') as writer:
        df.to_excel(writer, sheet_name="zambrow.org", index=True)
